...
class LunarCalendarView:NSViewController{
    ...
    func commonInit(){
        self.backgroundColor = NSColor.white.withAlphaComponent(0.0)
        self.textColor = NSColor.white
        self.selectionColor = NSColor.red.withAlphaComponent(0.0)
        self.todayMarkerColor = NSColor.green.withAlphaComponent(0.0)
        self.dayMakerColor = NSColor.white
        self.date = Date()
    }
